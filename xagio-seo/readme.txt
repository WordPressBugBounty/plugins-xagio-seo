...
### 🔥 Everything You Need for SEO - Completely Integrated

Xagio combines **AI-powered SEO** with essential site management tools, so you can **rank higher without expensive add-ons**.
...
### SEO Has Evolved - It's Time to Evolve With It 🚀
...
== Changelog ==
= 7.1.0.44 =
* ⚙️ Stability improvements and vulnerability fixes.
...
* 🐞 Fixed an issue where rank was displayed as null in certain cases.

= 7.1.0.32 =
* 🐞 Minor improvements to Agent X template selection.
* ⚙️ Agent X performance updates.
...
= 7.1.0.30 =
🎨 UI/Editor styling refinements and minor display fixes.
⚙️ Improved template application behavior and overall stability.

= 7.1.0.29 =
🐞 Fixed a bug with API keys not being recognized or generated.

= 7.1.0.28 =
🐞 Fixed a bug caused by WordPress 'wp_safe_redirect' function.

= 7.1.0.27 =
⚙️ Improved Agent X stability and performance across various hosting environments.
🐞 Fixed a critical bug where Agent X templates were occasionally failing to import on specific WordPress versions.

= 7.1.0.26 =
💡 Improved AI Clustering feature in Agent X, now with better usability.
⚙️ Optimized Database Query efficiency for the AI Assistant's content review process.
🐞 Resolved an issue causing intermittent failures during Google Maps API integration after Agent X setup.
🐛 Minor adjustments and fixes to the LLMs.txt feature in SEO Settings.

= 7.1.0.25 =
* ⚙️ Improved Agent X template handling for Elementor and Divi.
* 🐞 Fixed issues with background image rendering in AI Assistant.

= 7.1.0.24 =
* 💡 Improved Maps automatic set up after Agent X.
* 🐞 Minor Agent X bug fixes.

= 7.1.0.23 =
* 🐛 Minor Agent X changes.
* ⚙️ Adjusted AI Assistant Design.
* 🐞 Fixed issues with OneDrive backup.

= 7.1.0.22 =
* ✨ Enhanced functionality of AI Assistant, added support for Background Images.
* 📊 LLMs.txt feature added in SEO Settings.
* ⚙️ Optimized Agent X template page naming.
* 🐞 Fixed image replacement related issues with AI Assistant.

= 7.1.0.21 =
* 💡 Xagio AI Assistant feature added.
* 💡 AI Clustering feature added in Agent X.
* ⚙️ Fixed issues with templates not being properly modified by AI.
* 🐞 Added more debug information to help with error handling.

= 7.1.0.20 =
* 💡 Improved Agent X error reporting and validation.
* ⚙️ Stability improvements for better plugin performance.
* 🐞 Fixed UTF-8 encoding during content generation.

= 7.1.0.19 =
* ✨ Enhanced compatibility with Divi Theme.
* 🐞 Fixed reported issues/bugs.

= 7.1.0.18 =
* ⚙️ Agent X performance upgrades.
* 🐞 Minor improvements to Rank Tracking.

= 7.1.0.17 =
* ⚙️ Added compatibility fixes for older jQuery versions.
* 🐞 Additional escaping and sanitization to harden security.

= 7.1.0.16 =
* 🐛 Agent X improvements and stability upgrades.
...
= 7.1.0.14 =
* ⚙️ Stability improvements for better plugin performance.
* 🐞 Squashed bugs affecting edge-case metadata issues.

= 7.1.0.13 =
* 🧠 Improved AI meta suggestions across large keyword groups.
* 🐛 Fixed redirect rule inconsistencies in 301 manager.

= 7.1.0.12 =
* ✨ Enhanced compatibility with popular caching plugins.
* 📊 Improved reporting visuals for project overview.

= 7.1.0.11 =
* 🔍 More accurate keyword rank detection per page.
* 🐞 Fixed minor UI glitches in Project Planner.

= 7.1.0.10 =
* 🔁 Improved redirect logic for custom post types.
* 🛠️ Backend enhancements to support larger keyword imports.

= 7.1.0.9 =
* 🧩 Better compatibility with Gutenberg and page builders.
* 🔄 Smoother transitions when updating meta titles in bulk.

= 7.1.0.8 =
* 🐛 Fixed SEO audit display for long-tail keywords.
* ⚙️ Improved performance of AI clustering on high-volume sites.

= 7.1.0.7 =
* 🧠 More relevant AI schema output suggestions.
* 🐞 Fixed an issue where default meta descriptions weren't saved.

= 7.1.0.6 =
* 🚀 Faster loading of Project Planner dashboard.
* 🔧 Minor stability fixes.

= 7.1.0.5 =
* 🔍 Improvements to keyword grouping logic.
* 🐛 Fixed rare issues with schema injection on product pages.

= 7.1.0.4 =
* 💡 Added more context-aware AI suggestions for service pages.
* 🛠️ Bug fixes and compatibility updates.

= 7.1.0.3 =
* 📊 Improved CPC and competition display for keywords.
* 🐛 Minor bug fixes in link tracker stats.

= 7.1.0.2 =
* 🔐 Enhanced schema validation for review blocks.
* 🧹 Backend cleanup and small bug fixes.

= 7.1.0.1 =
* 🚦Improved error handling when saving large keyword lists.
...
= 7.0.0.14 to 7.0.0.35 =
* 🧹 Ongoing bug fixes and refinements based on user feedback.
* ⚙️ Enhanced support for SEO across PBNs and niche sites.
* 🛠️ Optimized AI processing speed for bulk operations.

= 7.0.0.0 to 7.0.0.14 =
* 🚀 Initial launch of Xagio SEO.
* 🧠 Core AI engine for generating titles, metas, content & schema.

== Upgrade Notice ==
* Upgrading from any previous version is seamless. Simply update the plugin from your WordPress dashboard. All your settings and customizations will remain intact.

== Third-Party Services ==

This plugin relies on third-party services to provide certain functionalities. Below is a list of the services used and the purposes for which they are used.

### Xagio Panel API
- *Purpose:* This service is used for license verification, updates, and website management, ensuring the plugin operates smoothly and stays up-to-date with the latest features and security patches.
- *Service URL:* [Xagio Panel](https://app.xagio.net)
- *Terms of Use:* [Xagio Panel Terms of Use](https://xagio.net/terms)
- *Privacy Policy:* [Xagio Panel Privacy Policy](https://xagio.net/privacy)

### Pixabay API
- *Purpose:* This service is used for sourcing royalty-free images to enhance content within the plugin.
- *Service URL:* [Pixabay](https://pixabay.com/api/)
- *Terms of Use:* [Pixabay Terms of Service](https://pixabay.com/service/terms/)
- *Privacy Policy:* [Pixabay Privacy Policy](https://pixabay.com/service/privacy/)

### YouTube Embeds
- *Purpose:* This service is used to embed YouTube videos within the plugin's UI, allowing users to easily add video content to their websites, which can enhance SEO through multimedia content.
- *Service URL:* [YouTube](https://www.youtube.com)
- *Terms of Use:* [YouTube Terms of Use](https://www.youtube.com/t/terms)
- *Privacy Policy:* [YouTube Privacy Policy](https://policies.google.com/privacy)

### Tawk.to
- *Purpose:* This service is used for live chat support, enabling real-time communication between users and support teams.
- *Service URL:* [Tawk.to](https://tawk.to)
- *Terms of Use:* [Tawk.to Terms of Use](https://www.tawk.to/terms-of-service/)
- *Privacy Policy:* [Tawk.to Privacy Policy](https://www.tawk.to/privacy-policy/)

### Dropbox API
- *Purpose:* This service is used for cloud storage and retrieval of content files, including images and backups.
- *Service URLs:*
  - [Content API](https://content.dropboxapi.com)
  - [API](https://api.dropboxapi.com)
- *Terms of Use:* [Dropbox Terms of Service](https://www.dropbox.com/terms)
- *Privacy Policy:* [Dropbox Privacy Policy](https://www.dropbox.com/privacy)

### Google APIs
- *Purpose:* This service is used for various Google functionalities, including Google Search Console integration, Google Drive access, and Google Analytics tracking.
- *Service URLs:*
...
### Microsoft Graph API
- *Purpose:* This service is used for integrating Microsoft services, including OneDrive and Microsoft Office 365.
- *Service URLs:*
  - [Graph API](https://graph.microsoft.com)
- *Terms of Use:* [Microsoft Terms of Use](https://www.microsoft.com/en-us/servicesagreement)
- *Privacy Policy:* [Microsoft Privacy Policy](https://privacy.microsoft.com/en-us/privacystatement)

### Microsoft Online Login
- *Purpose:* This service is used for authenticating users via Microsoft services, including Office 365 and OneDrive integrations within the plugin.
- *Service URL:* [Microsoft Online Login](https://login.microsoftonline.com)
- *Terms of Use:* [Microsoft Online Terms of Service](https://www.microsoft.com/en-us/servicesagreement)
- *Privacy Policy:* [Microsoft Privacy Policy](https://privacy.microsoft.com/en-us/privacystatement)

### Chrome Web Store
- *Purpose:* This service is used for distributing browser extensions associated with the plugin's functionalities.
- *Service URL:* [Chrome Web Store](https://chromewebstore.google.com)
- *Terms of Use:* [Chrome Web Store Terms of Service](https://www.google.com/chrome/privacy/eula_text.html)
- *Privacy Policy:* [Google Privacy Policy](https://policies.google.com/privacy)

### Facebook APIs
- *Purpose:* This service is used for social media integration, including posting to Facebook and accessing Facebook Insights.
- *Service URLs:*
  - [Facebook](https://www.facebook.com)
  - [Developers](https://developers.facebook.com)
- *Terms of Use:* [Facebook Terms of Service](https://www.facebook.com/terms.php)
- *Privacy Policy:* [Facebook Data Policy](https://www.facebook.com/policy.php)

### W3C Validator
- *Purpose:* This service is used for validating the plugin's generated HTML to ensure compliance with web standards.
- *Service URL:* [W3C Validator](http://www.w3.org)
- *Terms of Use:* [W3C Terms of Service](https://www.w3.org/Consortium/Legal/2015/terms-of-use)
- *Privacy Policy:* [W3C Privacy Policy](https://www.w3.org/Consortium/Legal/2015/privacy-statement)

### WordPress.org
- *Purpose:* This service is used for plugin updates, downloads, and API requests to the WordPress repository.
- *Service URLs:*
  - [WordPress](https://wordpress.org)
  - [Downloads](https://downloads.wordpress.org)
  - [API](http://api.wordpress.org)
- *Terms of Use:* [WordPress Terms of Service](https://wordpress.org/about/privacy/)
- *Privacy Policy:* [WordPress Privacy Policy](https://wordpress.org/about/privacy/)

### Bannerbear
- *Purpose:* This service is used for generating dynamic images and banners for SEO purposes.
- *Service URL:* [Bannerbear](https://www.bannerbear.com)
- *Terms of Use:* [Bannerbear Terms of Service](https://www.bannerbear.com/terms/)
- *Privacy Policy:* [Bannerbear Privacy Policy](https://www.bannerbear.com/privacy/)

### Schema.org
- *Purpose:* This service is used for structured data validation and schema generation to improve SEO.
- *Service URLs:*
  - [Schema.org Validator](https://validator.schema.org)
  - [Schema.org](http://schema.org)
- *Terms of Use:* [Schema.org Terms of Use](https://schema.org/docs/terms.html)
- *Privacy Policy:* [Schema.org Privacy Policy](https://schema.org/docs/privacy.html)

### Google Tag Manager
- *Purpose:* This service is used for managing and deploying marketing tags (snippets of code) on your website.
- *Service URL:* [Google Tag Manager](https://www.googletagmanager.com)
- *Terms of Use:* [Google Tag Manager Terms of Service](https://marketingplatform.google.com/about/analytics/tag-manager/use-policy/)
- *Privacy Policy:* [Google Privacy Policy](https://policies.google.com/privacy)

### Gravatar
- *Purpose:* This service is used for displaying user avatars in the plugin's UI based on their email addresses.
- *Service URL:* [Gravatar](https://gravatar.com/)
- *Terms of Use:* [Gravatar Terms of Service](https://wordpress.com/tos/)
- *Privacy Policy:* [Gravatar Privacy Policy](https://automattic.com/privacy/)

== Support ==

For any issues or support inquiries, please visit the [Xagio Support Center](https://support.xagio.net) or contact us directly through the plugin's support forum.